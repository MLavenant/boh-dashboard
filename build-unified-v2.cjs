...
/* Print / PDF export — RDG Portfolio */
@media print {
  @page { size: landscape; margin: 12mm; }
  body { background:#fff !important; color:#111 !important; }
  nav, .venue-pills, .tab-btn, footer, #portfolioPdfBtn, #weekWelcomePopup,
  #assignmentHelperBanner, .coming-note { display:none !important; }
  .tab-section { display:none !important; }
  #tab-group.tab-section, #tab-group.tab-section.active { display:block !important; }
  #tab-group .card { break-inside:avoid; border:1px solid #ccc !important; background:#fff !important; color:#111 !important; box-shadow:none !important; }
  #tab-group h2, #tab-group .section-title, #tab-group strong { color:#111 !important; }
  #tab-group .note, #tab-group td, #tab-group th { color:#333 !important; }
  #tab-group table { width:100% !important; font-size:10px !important; }
  #dashTitle, #dashBadge { color:#111 !important; }
}
</style>`);
...
function exportPortfolioPdf() {
  // Ensure Portfolio tab is visible, then open the browser print dialog (Save as PDF)
  const groupBtn = document.querySelector('.tab-btn[onclick*="group"]');
